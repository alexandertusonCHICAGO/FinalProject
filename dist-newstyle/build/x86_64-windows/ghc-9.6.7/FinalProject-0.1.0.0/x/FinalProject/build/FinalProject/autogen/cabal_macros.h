...
/* package FinalProject-0.1.0.0 */
#ifndef VERSION_FinalProject
#define VERSION_FinalProject "0.1.0.0"
#endif /* VERSION_FinalProject */
#ifndef MIN_VERSION_FinalProject
#define MIN_VERSION_FinalProject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_FinalProject */
...
#define CURRENT_COMPONENT_ID "FinalProject-0.1.0.0-inplace-FinalProject"
